...
class Formula
{
   ...
   private:
    ...
    void    printFullOccurrenceList(Variable var, std::ostream& stream) const;
    void    printOccurrenceList(Literal lit, std::ostream& stream) const;
