...
{
    // Assertion failed when hce = true and substitute = false
    // E.g. ./hqspre --hec 1 --substitute 0  ../../../../DQBFbenchmarks/benchmarks/original/Biere/adder_3_2/pec_adder_3_bit_2_0.dqdimacs
    // Probability seemed to be correct
